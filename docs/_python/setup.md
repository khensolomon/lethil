...
tooling. Once the environment is ready, see [[Packaging scripts]] for how the
CLI tools are structured.

These scripts often run on the [[Docker Swarm]] host, so the same Python
