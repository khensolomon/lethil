...
/**
 * Prepare environment
 * Read `.env` & `package.json`
 * It's too late to initiate the core have been setup
 */
 ...
 * @alias service.digit
 */
export const digit = service.digit;

/**
 * Command line prompt
 * @class
 * @alias service.prompt
 */
export const Prompt = service.prompt;
