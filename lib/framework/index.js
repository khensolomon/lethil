...
export class Command extends Core {
  req = {
    method: "get",
    url: aid.parse.cli($.config.param),
    // pathname: "",
    params: {},
    query: {},
    route: {},
...
export class Server extends Core {
   ...
   * @param {(req:any, res:any) => void} listener
   * @example
   * .on('request', async (req, res) => 'Ok');
   * .on('request', function (req, res) {})
   * .on('listening', (e) => console.log(e));
   * .on('connection', (e) => console.log(e));
   * .on('error', (e) => console.log(e));
   * .on('close', (e) => console.log('closed',e));
   *
  ...
  // Command.prototype.on("request", function (req, res) {});
