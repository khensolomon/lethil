...
module.exports = class Burglish {
  constructor(str) {
    this.query = str;
    this.text = str;
  }
  get toUnicode(){
    return this.convert(ruleUnicode);
  }
  get toZawgyi(){
    return this.convert(ruleZawgyi);
  }
  convert(rule){
    for (const e of rule) this.text = this.text.replace(new RegExp(e.from,"g"),e.to);
    return this.text;
  }
}
const ruleZawgyi = [
