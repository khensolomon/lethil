...
describe("check.validate(str): XSS query", () => {
  ...
  it("Basic XSS", () => {
    assert.strictEqual(
      "",
      check.validate("<SCRIPT SRC=http://xss.rocks/xss.js></SCRIPT>")
    );
  });
  ...
  it("Malformed A Tags", () => {
    assert.strictEqual(
      "",
      check.validate('<a onmouseover="alert(document.cookie)">xxs link</a>')
    );
    assert.strictEqual(
      "",
      check.validate("<a onmouseover=alert(document.cookie)>xxs link</a>")
  ...
  it("Malformed IMG Tags", () => {
    assert.strictEqual(
      "",
      check.validate('<IMG """><SCRIPT>alert("XSS")</SCRIPT>">')
    );
    assert.strictEqual(
      "",
      check.validate(
    ...
    assert.strictEqual(
      "",
      check.validate("<IMG SRC=# onmouseover=\"alert('xxs')\">")
    );
    assert.strictEqual(
      "",
      check.validate("<IMG SRC= onmouseover=\"alert('xxs')\">")
    ...
    assert.strictEqual(
      "",
      check.validate("<IMG onmouseover=\"alert('xxs')\">")
    );
    assert.strictEqual(
      "",
      check.validate(
    ...
    assert.strictEqual(
      "",
      check.validate("<IMG SRC=\"jav ascript:alert('XSS');\">")
    );
  });
  ...
  it("Malformed SCRIPT Tags", () => {
    assert.strictEqual(
      "",
      check.validate('<<SCRIPT>alert("XSS");//<</SCRIPT>')
    );
    assert.strictEqual(
      "",
      check.validate("<SCRIPT SRC=http://xss.rocks/xss.js?< B >")
    );
    assert.strictEqual("", check.validate("<SCRIPT SRC=//xss.rocks/.j>"));
  });

  it("Malformed <?<|>?> Tags", () => {
    assert.strictEqual(
      "",
      check.validate("<iframe src=http://xss.rocks/scriptlet.html\n <")
    );
  });
